...
Se você ainda não fez isso, junte-se a nós no [nosso grupo aberto do Telegram](https://t.me/GrupyRN)
...
[`README.md`](https://github.com/grupyrn/jararaca/blob/main/README.md).
...
* Se não, [crie uma _issue_](https://github.com/grupyrn/jararaca/issues/new)
...
- Compartilhar a sua sugestão com outros participantes e mantenedores do projeto em nosso [Telegram](https://t.me/GrupyRN)
...
Mais detalhes [aqui](https://docs.github.com/pt/pull-requests/collaborating-with-pull-requests).
...
* Atualize o [README.md](https://github.com/grupyrn/jararaca/blob/main/README.md)
