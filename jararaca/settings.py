...
ALLOWED_HOSTS = ['meetup.grupyrn.org', 'www.meetup.grupyrn.org', 'localhost', '127.0.0.1', 'grupyrn.sedir.dev']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'jararaca.context_processors.global_settings',
            ],
        },
    },
]
